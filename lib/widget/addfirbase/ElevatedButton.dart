        ...
        onPressed: () {
          if (_formKey.currentState?.saveAndValidate() ?? false) {
            ...
            final double pricePerUnit =
                double.tryParse(formData['pricePerUnit'] ?? '') ?? 0.0;
            final double productsPerCarton =
                double.tryParse(formData['productsPerCarton'] ?? '') ?? 0.0;
            final double r = quantity * productsPerCarton;
            final totalPrice = r * pricePerUnit;
            ...
            DatabaseReference newProductRef =
                databaseReference.child('foots').push();
